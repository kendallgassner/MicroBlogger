...
export default class App extends React.Component<{}, AppState> {
  ...
  render() {
    ...
    return (
      <Router>
        <div className="App">
          {showBanner && (
            <Banner isError={isError} closeBanner={this.closeBanner} message={bannerMessage} />
          )}
          <h1>Microblogger</h1>
          <Route path="/" exact component={this.createHome} />
  ...
  private readonly createAddPost = (props: any) => (
    <AddPost updateBanner={this.updateBanner} {...props} />
  );
}
